...
// The robot's subsystems
    ...
    public final Elevator_Lock m_elevator_Lock = new Elevator_Lock();
...
private RobotContainer() {
  SmartDashboard.putNumber("Angle", 45);
    ...
    SmartDashboard.putData("Lock to 30", new Elevator_Lock_SetAngle(30, m_elevator_Lock));
    SmartDashboard.putData("Lock to 100", new Elevator_Lock_SetAngle(100, m_elevator_Lock));
    SmartDashboard.putData("Lock to sp", new Elevator_Lock_SetAngle_SD(m_elevator_Lock));
    
    SmartDashboard.putData("Disable Servor", new InstantCommand(m_elevator_Lock::disableServo,m_elevator_Lock));
